    ...
    <div class="card mb-3">
      ...
      <div class="card-body pb-2">
          ...
          <div class="col-md-6">
            <div class="form-group">
              ...
              <input id="price" type="number" class="form-control{{ $errors->has('price') ? ' is-invalid' : '' }}"
                name="price" value="{{ old('price', $advert->price) }}" required>
              @if ($errors->has('price'))
        ...
        <div class="form-group">
          ...
          <input id="address" type="number" class="form-control{{ $errors->has('address') ? ' is-invalid' : '' }}"
        ...
        <div class="form-group">
          ...
          <textarea id="content" class="form-control{{ $errors->has('content') ? ' is-invalid' : '' }}" name="content"
            rows="10" required>{{ old('content', $advert->content) }}</textarea>
